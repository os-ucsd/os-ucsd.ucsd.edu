            ...
            return (
                <footer>
                    <ul className="icons">
                        ...
                        <li>
                            <a href="https://github.com/os-ucsd"><GitHubIcon className="button" style={{ fill: "white", width: 30, height: 30 }} /></a>
                        </li>
                        <li>
                            <a href="/contact"><MailIcon className="button" style={{ fill: "white", width: 30, height: 30 }} /></a>
                        </li>
                        <li>
                            <a href="https://discord.gg/v4BrEx"><img className="button" src={discordIcon} height="30px" width="30px" alt="discord" /></a>
                        </li>
                    </ul>
